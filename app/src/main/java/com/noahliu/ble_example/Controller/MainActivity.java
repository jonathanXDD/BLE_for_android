...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx5=findViewById(R.id.textViewHIHI);
    }
    /**權限相關認證*/
    ...
    private void bluetoothScan() {
        /**啟用藍牙適配器*/
        Log.d(TAG, "bluetoothScan.. Context.BLUETOOTH_SERVICE.."+ Context.BLUETOOTH_SERVICE );
    ...
    private RecyclerViewAdapter.OnItemClick itemClick = new RecyclerViewAdapter.OnItemClick() {
        ...
        public void onItemClick(ScannedData selectedDevice) {
            ...
            Toast.makeText(MainActivity.this, "p001", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            Toast.makeText(MainActivity.this, "p002", Toast.LENGTH_SHORT).show();
        }
    };
